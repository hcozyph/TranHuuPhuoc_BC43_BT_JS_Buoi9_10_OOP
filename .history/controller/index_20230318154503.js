...
getEle('btnThemNV').onclick = function () {
    ...
    // var valid = true;
    // valid = check.kiemTraRong(sv.maSinhVien, 'error-required-maSinhVien', 'Mã sinh viên') & kiemTra.kiemTraRong(sv.tenSinhVien, 'error-required-tenSinhVien', 'Tên sinh viên') & kiemTra.kiemTraRong(sv.email, 'error-required-email', 'Email');
